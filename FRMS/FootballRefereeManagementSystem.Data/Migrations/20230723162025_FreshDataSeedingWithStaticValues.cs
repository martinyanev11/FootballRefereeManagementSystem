...
{
    public partial class FreshDataSeedingWithStaticValues : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("065a8654-fc52-43b4-8d3d-7e90a87e2bd9"), 0, null, "b260400a-d943-416a-a368-c2109caee327", "assitant_referee2@bfs.com", false, false, null, "ASSITANT_REFEREE2@BFS.COM", "ASSITANT_REFEREE2@BFS.COM", "AQAAAAEAACcQAAAAEE/T+fLS7QH3q6CjHqZ673DuIIp9+MlTxGh+8dOqSCSi+wcUADpptXxWOhlp/sUC8A==", null, false, 3, "54aa92fc-e351-4099-b8c2-2e11844b5055", false, "assitant_referee2@bfs.com" },
                    { new Guid("1e48bbc8-cbf0-494c-89e0-6bcccc36cc6a"), 0, null, "d879322c-9b6c-4add-9117-60aeb4129444", "assitant_referee1@bfs.com", false, false, null, "ASSITANT_REFEREE1@BFS.COM", "ASSITANT_REFEREE1@BFS.COM", "AQAAAAEAACcQAAAAEEUx9hbIYRbRe2NkovSYXsiq6N8QBa7pnciLle0GPVZvOnrzA7oyVU1rhKQpvYbjdQ==", null, false, 2, "953c5389-11bf-4a85-985e-8838dbc244e9", false, "assitant_referee1@bfs.com" },
                    { new Guid("35e56d1c-a7c2-445d-9eb5-0cdaecb0ebb1"), 0, null, "505499f7-7083-4c23-8d71-af28f3bf52ba", "delegate@bfs.com", false, false, null, "DELEGATE@BFS.COM", "DELEGATE@BFS.COM", "AQAAAAEAACcQAAAAEK1ejvrupZAl4gJiZVWXKiBjiV81CvUT+Le0gTmp5xlgZtqHOVM300e6xEoeY1QD1w==", null, false, 4, "0d2f845c-5cff-4c19-9b10-897c8e4293bf", false, "delegate@bfs.com" },
                    { new Guid("d9f18631-5bdb-4b41-86f4-8d6dbe71efb6"), 0, null, "1db3708c-c789-46dd-b26b-f987102eef22", "admin@bfs.com", false, false, null, "ADMIN@BFS.COM", "ADMIN@BFS.COM", "AQAAAAEAACcQAAAAECcZVKrCN0qLtsizFnErnhaHjV+I77W2vHO3VTbI8Z0uOr0ATxypAdyMhIHoPnWoCw==", null, false, 5, "e2dc0205-924a-40d8-88f7-7ebf282eba0f", false, "admin@bfs.com" },
                    { new Guid("ea01fe26-36c8-4daa-b1c8-8b9209e82478"), 0, null, "ecc1779d-5c6a-410e-8bc9-8c24fcf629c1", "referee@bfs.com", false, false, null, "REFEREE@BFS.COM", "REFEREE@BFS.COM", "AQAAAAEAACcQAAAAENbLLD5uh+Z+y0MGod/OQcZo3ZE17xzY4mmFmHONDDsn4BxQYFZrugiUjoiEk/CyNw==", null, false, 1, "db733aa2-e6af-45eb-89f4-f313843a9477", false, "referee@bfs.com" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Seasons",
                columns: new[] { "Id", "Description", "End", "Start" },
                values: new object[] { 2, "2022/23", new DateTime(2024, 6, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 9, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) });
