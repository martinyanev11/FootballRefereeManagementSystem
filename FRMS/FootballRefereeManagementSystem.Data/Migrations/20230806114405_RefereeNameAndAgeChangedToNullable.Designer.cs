...
namespace FootballRefereeManagementSystem.Data.Migrations
{
    ...
    [Migration("20230806114405_RefereeNameAndAgeChangedToNullable")]
    partial class RefereeNameAndAgeChangedToNullable
    {
            ...
            modelBuilder.Entity("FootballRefereeManagementSystem.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3eef2917-4e17-4996-8835-5470a3474103",
                            Email = "referee@bfs.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "REFEREE@BFS.COM",
                            NormalizedUserName = "REFEREE@BFS.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEKL4NmRSMGJaffkRT2j2Ks46HLbtmZm25TCfgMhdaEzjNfEC0BcGjH6f31lx+GpwSg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d14b0979-678d-416a-86f7-75a36ca554d5",
                            Email = "assitant_referee1@bfs.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ASSITANT_REFEREE1@BFS.COM",
                            NormalizedUserName = "ASSITANT_REFEREE1@BFS.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEGXnkUO89nlje1MIHvmBzgWP8MNw2y6nHNjPl2BDZ14b9FZzNDUGbEKMP2KkYn8L0g==",
                            PhoneNumber = "0897123456",
                            PhoneNumberConfirmed = false,
                            RefereeId = 2,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3f226a8e-935c-4411-9591-25957af69e90",
                            Email = "assitant_referee2@bfs.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ASSITANT_REFEREE2@BFS.COM",
                            NormalizedUserName = "ASSITANT_REFEREE2@BFS.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEJMJfGrX8PDFUxpQ4k/sqrT6IwYKvgco5s35sc2jWHkMpaGNhFRjuYzYnjhzDiXlDw==",
                            PhoneNumber = "0897123456",
                            PhoneNumberConfirmed = false,
                            RefereeId = 3,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8ecec81f-85d8-469d-a6ba-f1203b790de2",
                            Email = "delegate@bfs.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "DELEGATE@BFS.COM",
                            NormalizedUserName = "DELEGATE@BFS.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEJNbeecT6bM9B62e66Iv1rYaIhrJbi6lCDHDjW8CkivMO0daiAz1Ob5tb6XNRayndg==",
                            PhoneNumber = "0897123456",
                            PhoneNumberConfirmed = false,
                            RefereeId = 4,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a8dacc93-6f0b-4596-be2d-7de398f8ee1c",
                            Email = "admin@bfs.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@BFS.COM",
                            NormalizedUserName = "ADMIN@BFS.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEE+N67ZKdRReLIa/+NOYYduTWBmeGHPy9vyER3f4uIXLGK1vkXpvtgu22lmnEWbMGw==",
                            PhoneNumber = "0897123456",
                            PhoneNumberConfirmed = false,
                            RefereeId = 5,
            ...
            modelBuilder.Entity("FootballRefereeManagementSystem.Data.Models.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 8, 6, 11, 44, 4, 138, DateTimeKind.Utc).AddTicks(2035),
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 8, 6, 11, 44, 4, 138, DateTimeKind.Utc).AddTicks(2040),
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 8, 6, 11, 44, 4, 138, DateTimeKind.Utc).AddTicks(2041),
                            IsActive = true,
                            Title = "Решение на ДК- ОС на БФС Плевен"
                        },
                        new
